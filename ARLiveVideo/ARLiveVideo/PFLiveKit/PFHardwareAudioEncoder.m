...
@interface PFHardwareAudioEncoder (){
...
@property (nonatomic, strong) PFLiveAudioConfiguration *configuration;
@property (nonatomic, weak) id<PFAudioEncodingDelegate> aacDeleage;

@end

@implementation PFHardwareAudioEncoder
- (instancetype)initWithAudioStreamConfiguration:(nullable PFLiveAudioConfiguration *)configuration {
    if (self = [super init]) {
...
- (void)setDelegate:(id<PFAudioEncodingDelegate>)delegate {
